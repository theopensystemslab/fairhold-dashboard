...
export const Footer: React.FC = () => (
  <footer className="footer mt-5 text-sm leading-21 md:text-base">
    <div className="w-layout-blockcontainer container w-container">
      <div className="columns w-row">
        ...
        <div className="column-5 w-col w-col-3">
          <div className="social-links">
            <a
              href="https://twitter.com/WikiHouse"
              target="_blank"
            ...
            >
              <Image
                width="30"
                height="30"
                sizes="(max-width: 479px) 17vw, 30px"
                alt="Twitter logo"
            ...
            <a
              href="https://github.com/wikihouseproject/Skylark"
              target="_blank"
            ...
            <a
              href="https://www.youtube.com/channel/UCdaCCzZijlUBU6ntv_Xrd8w"
              target="_blank"
              className="social-media-link w-inline-block"
            >
              <Image
      ...
      <div className="columns w-row">
        <div className="column-6 w-col w-col-3">
          ...
          <a href="#" className="osl-logo w-inline-block">
            <Image
        ...
        <div className="column-4 w-col w-col-6">
          <div className="!text-white">Funded by</div>
          <div className="spacer _20"></div>
          <div className="flex">
        ...
        <div className="column-5 w-col w-col-3 mt-6 md:mt-0">
          <div className="!text-white text-sm leading-21 md:text-base">
            © Open Systems Lab 2025 <br />
            <br />
            <div className="text-sm hidden md:block">
              Open Systems Lab / OSL is a non-profit company 9152368
              <br />
