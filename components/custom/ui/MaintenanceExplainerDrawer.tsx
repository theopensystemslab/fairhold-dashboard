...
export const MaintenanceExplainerDrawer = () => (
  ...
  >
    <div className="text-sm --text-default-rgb space-y-7 mt-7">
      <div>
        <p>
      ...
      <div>
        <a href="https://github.com/theopensystemslab/fairhold-dashboard/wiki" className="--text-default-rgb">Find out more about how we have modelled building depreciation</a>
      </div>
    </div>
  </Drawer >
)