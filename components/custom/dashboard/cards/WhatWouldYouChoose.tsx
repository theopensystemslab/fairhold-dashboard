...
export const WhatWouldYouChoose: React.FC = () => {
  return (
    <div className="min-h-screen h-screen snap-start w-full justify-center p-10 flex flex-col overflow-y-auto my-2 pb-6">
      <div className="h-2/3 flex flex-col w-full gap-6">
